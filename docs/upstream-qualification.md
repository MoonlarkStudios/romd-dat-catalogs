...
public DAT-enabled records are now reconciled and the operator has approved
redistribution/retention. SNES deployment and initial ROMD acceptance are complete;
see the [current closeout](catalog-expansion-plan.md). Other catalogs remain unqualified.
